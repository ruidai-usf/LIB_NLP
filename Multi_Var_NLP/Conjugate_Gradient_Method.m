function [opt_solution, opt_fun_val, iter_info, exit_flag] = Conjugate_Gradient_Method(obj_function, ...
...
[temp_val, ini_grad] = feval(obj_function,current_sol);
direction = -ini_grad;
iteration_info = [];
...
for i = 1:iter_num
    ...
    direction = -temp_grad_new + (norm(temp_grad_new)^2/norm(temp_grad)^2)*direction;
