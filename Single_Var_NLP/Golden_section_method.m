function [opt_solution, opt_fun_val, iter_info, exit_flag] = Golden_section_method(obj_function, ...
...
for i = 1:iter_num
    ...
    lambada = alpha*current_lower+(1-alpha)*current_upper;
    miu = (1-alpha)*current_lower+alpha*current_upper;
